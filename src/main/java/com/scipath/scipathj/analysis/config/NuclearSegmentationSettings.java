...
public record NuclearSegmentationSettings(
   ...
   */
  public String getMinNucleusSizeWithUnit(com.scipath.scipathj.infrastructure.config.MainSettings mainSettings) {
   ...
   * @return Formatted string with scale unit
   */
  public String getMaxNucleusSizeWithUnit(com.scipath.scipathj.infrastructure.config.MainSettings mainSettings) {
