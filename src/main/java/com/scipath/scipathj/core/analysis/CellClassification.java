...
public class CellClassification {
    ...
    public CellClassification(String imageFileName, Map<String, Map<String, Double>> features) {
        ...
        LOGGER.debug("CellClassification initialized for image: {} (TODO: not implemented)", imageFileName);
    }
    ...
    public static class ClassificationResult {
        ...
        public ClassificationResult(String roiName, String predictedClass, double confidence, 
        ...
        public String toString() {
            return String.format("ClassificationResult[%s: %s (%.3f)]", 
                               roiName, predictedClass, confidence);
        }
    }
}