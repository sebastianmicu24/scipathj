...
public class ConfigurationManager {
    ...
    public void saveVesselSegmentationSettings(VesselSegmentationSettings settings) {
        ...
        properties.setProperty("applyMorphologicalClosing", String.valueOf(settings.isApplyMorphologicalClosing()));
    ...
    public void saveMainSettings(MainSettings settings) {
        ...
        // Save scale settings
        properties.setProperty("pixelsPerMicrometer", String.valueOf(settings.getPixelsPerMicrometer()));
        ...
        properties.setProperty("roiFillOpacity", String.valueOf(settings.getVesselSettings().getFillOpacity()));
        properties.setProperty("roiBorderWidth", String.valueOf(settings.getVesselSettings().getBorderWidth()));
     ...
     */
    private void loadROICategorySettings(Properties properties, String categoryPrefix, MainSettings.ROIAppearanceSettings settings) {
        // Load border color
     ...
     */
    private void saveROICategorySettings(Properties properties, String categoryPrefix, MainSettings.ROIAppearanceSettings settings) {
        properties.setProperty(categoryPrefix + ".borderColor", colorToString(settings.getBorderColor()));
        properties.setProperty(categoryPrefix + ".fillOpacity", String.valueOf(settings.getFillOpacity()));
        properties.setProperty(categoryPrefix + ".borderWidth", String.valueOf(settings.getBorderWidth()));
    }
