...
public class ImageMetadata {
    ...
    public ImageMetadata(String filename, int width, int height, int channels, 
                        String pixelType, double pixelSizeX, double pixelSizeY, String unit) {
    ...
    public LocalDateTime getAcquisitionTime() { return acquisitionTime; }
