...
public class CellROI extends UserROI {
    ...
    private void calculateNucleusToCytoplasmRatio() {
        if (associatedNucleus != null && associatedCytoplasm != null) {
            ...
            LOGGER.debug("Calculated N/C ratio for {}: {:.3f} (nucleus: {:.1f}, cytoplasm: {:.1f})",
                        getName(), nucleusToCytoplasmRatio, nucleusArea, cytoplasmArea);
        }
    }
    ...
    public String toString() {
        return String.format("CellROI[%s: area=%.1f, complete=%s, N/C=%.3f]",
