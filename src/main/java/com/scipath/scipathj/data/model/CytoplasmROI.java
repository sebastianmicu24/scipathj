...
public class CytoplasmROI extends UserROI {
    ...
    public CytoplasmROI(Roi roi, String imageFileName, String cytoplasmName) {
        ...
        LOGGER.debug("Created CytoplasmROI: {} with area: {:.1f} pixels (complex shape: {})",
                    cytoplasmName, cytoplasmArea, hasComplexShape());
    }
     ...
     */
    public CytoplasmROI(Roi roi, String imageFileName, String cytoplasmName, NucleusROI associatedNucleus) {
        ...
        if (associatedNucleus != null) {
            ...
            setNotes(String.format("Cytoplasm region for %s. Created by subtraction from Voronoi cell.", nucleusName));
        }
    }
    ...
    public String toString() {
        return String.format("CytoplasmROI[%s: area=%.1f, nucleus=%s, cell=%s]",
                           getName(), cytoplasmArea, 
