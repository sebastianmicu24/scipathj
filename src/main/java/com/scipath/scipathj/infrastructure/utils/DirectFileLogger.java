...
public class DirectFileLogger {
  ...
  public static synchronized void initialize() {
    ...
    try {
      ...
      writeToFile(
          ...
          "INFO",
          "DirectFileLogger",
          "Direct file logger initialized successfully");
      writeToFile(
          "direct-debug.log",
          "INFO",
          "DirectFileLogger",
  ...
  public static void writeException(
      String filename, String level, String logger, String message, Throwable throwable) {
    if (!initialized) {
      initialize();
    }
    ...
    try {
      ...
      System.err.println(
          "Failed to write exception to log file " + filename + ": " + e.getMessage());
      e.printStackTrace();
    }
  }
  ...
  public static void logSystemInfo() {
    ...
    writeToFile(
        "system-info.log", "INFO", "System", "Java Version: " + System.getProperty("java.version"));
    writeToFile(
        "system-info.log", "INFO", "System", "Java Vendor: " + System.getProperty("java.vendor"));
    writeToFile(
        "system-info.log", "INFO", "System", "Java Home: " + System.getProperty("java.home"));
    writeToFile("system-info.log", "INFO", "System", "OS Name: " + System.getProperty("os.name"));
    writeToFile(
        "system-info.log", "INFO", "System", "OS Version: " + System.getProperty("os.version"));
    writeToFile(
        "system-info.log", "INFO", "System", "OS Architecture: " + System.getProperty("os.arch"));
    writeToFile(
        "system-info.log", "INFO", "System", "User Name: " + System.getProperty("user.name"));
    writeToFile(
        "system-info.log", "INFO", "System", "User Home: " + System.getProperty("user.home"));
    writeToFile(
        "system-info.log", "INFO", "System", "User Directory: " + System.getProperty("user.dir"));
    writeToFile(
        "system-info.log",
        "INFO",
        "System",
