...
public class ProcessingResult {
  ...
  public static ProcessingResult success(
      String imageName, List<UserROI> detectedROIs, Map<String, Object> metrics) {
    Duration duration =
        metrics.containsKey("processingTime")
  ...
  public String toString() {
    if (success) {
      return String.format(
          "ProcessingResult{imageName='%s', success=true, roiCount=%d, duration=%dms}",
          imageName, detectedROIs.size(), processingDuration.toMillis());
    } else {
      return String.format(
          "ProcessingResult{imageName='%s', success=false, error='%s'}", imageName, errorMessage);
    }
  }
}
