...
public final class UIUtils {
  ...
  public static Color getHoverColor() {
    return ThemeManager.isDarkTheme() ? new Color(255, 255, 255, 100) : new Color(0, 0, 0, 100);
  }
  ...
  public static Color getBackgroundColor(boolean highlighted) {
    if (highlighted) {
      return ThemeManager.isDarkTheme() ? new Color(70, 130, 180, 40) : new Color(70, 130, 180, 30);
    } else {
      return ThemeManager.isDarkTheme() ? new Color(255, 255, 255, 10) : new Color(0, 0, 0, 5);
    }
  }
  ...
  public static Color getBorderColor(boolean focused) {
    if (focused) {
      ...
      return ThemeManager.isDarkTheme() ? new Color(80, 80, 80) : new Color(200, 200, 200);
    }
  }
