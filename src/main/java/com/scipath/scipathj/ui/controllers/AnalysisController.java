        ...
        currentAnalysisWorker = new SwingWorker<Void, String>() {
            ...
            protected Void doInBackground() throws Exception {
                try {
                    ...
                    VesselSegmentationSettings vesselSettings = ConfigurationManager.getInstance().initializeVesselSegmentationSettings();
                    NuclearSegmentationSettings nuclearSettings = ConfigurationManager.getInstance().initializeNuclearSegmentationSettings();
                    AnalysisPipeline pipeline = new AnalysisPipeline(vesselSettings, nuclearSettings);
                    ...
                    publish(String.format("Analysis completed! Found %d vessels and %d nuclei across %d images.",
                                        results.getTotalVessels(), results.getTotalNuclei(), results.getProcessedImages()));
            ...
            protected void done() {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                        ...
                        "Remaining steps: Cytoplasm, Features, Classification, Statistics (TODO)\n\n" +
