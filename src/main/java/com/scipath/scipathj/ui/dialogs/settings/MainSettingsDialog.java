...
public class MainSettingsDialog extends JDialog {
    ...
    public MainSettingsDialog(Frame parent) {
    ...
    private void initializeDialog() {
        ...
        // Title
        JLabel titleLabel = UIUtils.createBoldLabel("Main Application Settings", 
    ...
    private JPanel createScaleConversionPanel() {
        ...
        JLabel pixelsPerMicrometerLabel = UIUtils.createLabel("Pixels per Micrometer:", UIConstants.NORMAL_FONT_SIZE, null);
        ...
        gbc.weightx = 1.0;
        pixelsPerMicrometerSpinner = new JSpinner(new SpinnerNumberModel(
            MainSettings.DEFAULT_PIXELS_PER_MICROMETER, 0.001, 1000.0, 0.1));
        ...
        scaleUnitField.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            public void insertUpdate(javax.swing.event.DocumentEvent e) { updateScalePreview(); }
            public void removeUpdate(javax.swing.event.DocumentEvent e) { updateScalePreview(); }
            public void changedUpdate(javax.swing.event.DocumentEvent e) { updateScalePreview(); }
        });
    ...
    private class ROICategoryPanel extends JPanel {
        ...
        public ROICategoryPanel(MainSettings.ROICategory category) {
            ...
            borderColorButton.setToolTipText("Click to change " + category.getDisplayName() + " ROI border color");
            ...
            fillOpacityLabel.setToolTipText("Opacity of " + category.getDisplayName() + " ROI fill (0% = transparent, 100% = opaque)");
            ...
            borderWidthLabel.setToolTipText("Width of " + category.getDisplayName() + " ROI borders in pixels");
            ...
            borderWidthSpinner.setToolTipText("Width of " + category.getDisplayName() + " ROI borders in pixels");
            ...
            previewPanel.setBorder(BorderFactory.createTitledBorder(category.getDisplayName() + " ROI Preview"));
        ...
        private void chooseBorderColor() {
            ...
            Color newColor = JColorChooser.showDialog(MainSettingsDialog.this,
                "Choose " + category.getDisplayName() + " ROI Border Color", currentColor);
            if (newColor != null) {
        ...
        public boolean validateInputs() {
            try {
                ...
                if (opacity < 0.0f || opacity > 1.0f) {
                    showErrorMessage(category.getDisplayName() + " ROI fill opacity must be between 0% and 100%");
                    return false;
                }
                ...
                showErrorMessage("Invalid " + category.getDisplayName() + " ROI settings: " + e.getMessage());
                return false;
            }
        }
    }
    ...
    private void updateScalePreview() {
        try {
            ...
            scalePreviewLabel.setText(String.format("Preview: 100 pixels = %.2f %s", micrometersFor100Pixels, unit));
        } catch (Exception e) {
    ...
    private class ROIPreviewPanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            Color fillColor = new Color(borderColor.getRed(), borderColor.getGreen(),
                                      borderColor.getBlue(), Math.round(opacity * 255));
