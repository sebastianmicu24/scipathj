...
public class PreferencesDialog extends JDialog {
    ...
    private JPanel createAppearanceSection() {
        ...
        gbc.insets = new Insets(UIConstants.MEDIUM_SPACING, UIConstants.MEDIUM_SPACING, UIConstants.MEDIUM_SPACING, UIConstants.MEDIUM_SPACING);
        ...
        gbc.gridwidth = 2;
        JLabel descriptionLabel = UIUtils.createLabel("<html><i>Choose between light and dark theme for the application interface.</i></html>",
                                                     UIConstants.TINY_FONT_SIZE, Color.GRAY);
    ...
    private JPanel createButtonPanel() {
        ...
        JButton okButton = createDialogButton("OK", FontAwesomeSolid.CHECK_CIRCLE, e -> { applySettings(); dispose(); });
    ...
    private JButton createDialogButton(String text, FontAwesomeSolid icon, java.awt.event.ActionListener listener) {
    ...
    private void applySettings() {
        try {
            ...
            settingsChanged = false;
            showMessage("Settings applied successfully!", "Settings Applied", JOptionPane.INFORMATION_MESSAGE);
            
        } catch (Exception e) {
            showMessage("Failed to apply settings: " + e.getMessage(), "Settings Error", JOptionPane.ERROR_MESSAGE);
        }
    }
