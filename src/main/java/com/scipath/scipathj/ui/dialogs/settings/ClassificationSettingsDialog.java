...
public class ClassificationSettingsDialog extends JDialog {
    ...
    private void initializeDialog() {
        ...
        JLabel titleLabel = UIUtils.createBoldLabel("Classification Settings", UIConstants.SUBTITLE_FONT_SIZE);
    ...
    private JPanel createSettingsPanel() {
        ...
        addSettingRow(panel, gbc, "XGBoost Model:", "liver_he_v1.model", "XGBoost model file for classification");
        addSettingRow(panel, gbc, "Confidence Threshold:", "0.7", "Minimum confidence for classification (0.0-1.0)");
        addSettingRow(panel, gbc, "Feature Selection:", "auto", "Feature selection method (auto/manual)");
