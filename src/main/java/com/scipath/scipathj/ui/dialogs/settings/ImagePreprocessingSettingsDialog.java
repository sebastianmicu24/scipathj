...
public class ImagePreprocessingSettingsDialog extends JDialog {
    ...
    private void initializeDialog() {
        ...
        // Title
        JLabel titleLabel = UIUtils.createBoldLabel("Image Preprocessing Settings", 
    ...
    private JPanel createSettingsPanel() {
        ...
        addSettingRow(panel, gbc, "Gaussian Blur Sigma:", "2.0", 
                     "Standard deviation for Gaussian blur preprocessing");
        
        // Brightness Adjustment
        addSettingRow(panel, gbc, "Brightness Adjustment:", "0", 
                     "Brightness adjustment value (-100 to +100)");
        
        // Contrast Enhancement
        addSettingRow(panel, gbc, "Contrast Enhancement:", "1.0", 
                     "Contrast multiplication factor (0.1 to 3.0)");
        
        // Noise Reduction
        addSettingRow(panel, gbc, "Noise Reduction:", "true", 
                     "Enable noise reduction preprocessing");
        
        // Color Normalization
        addSettingRow(panel, gbc, "Color Normalization:", "false", 
                     "Enable color normalization");
