...
public class FinalAnalysisSettingsDialog extends JDialog {
  ...
  private void initializeDialog() {
    ...
    JLabel titleLabel =
        UIUtils.createBoldLabel("Final Analysis Settings", UIConstants.SUBTITLE_FONT_SIZE);
  ...
  private JPanel createSettingsPanel() {
    ...
    addSettingRow(
        panel, gbc, "Include Raw Data:", "true", "Include individual cell data in export");
    addSettingRow(
        panel, gbc, "Statistical Summary:", "true", "Generate statistical summary report");
