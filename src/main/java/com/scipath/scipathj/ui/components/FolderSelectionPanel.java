...
public class FolderSelectionPanel extends JPanel {
    ...
    private void paintDropAreaBackground(Graphics g) {
        ...
        Color backgroundColor = dragOver ?
        ...
        g2d.setStroke(new BasicStroke(2f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10f, new float[]{10f, 10f}, 0f));
        g2d.drawRoundRect(1, 1, width - 2, height - 2, UIConstants.BORDER_RADIUS, UIConstants.BORDER_RADIUS);
    ...
    private void addDropAreaContent(JPanel panel) {
        ...
        panel.add(UIUtils.createIconLabel(FontAwesomeSolid.FOLDER_OPEN, 64, UIManager.getColor("Label.disabledForeground")), gbc);
        
        // Instructions
        gbc.gridy++; gbc.insets = new Insets(0, 0, UIConstants.TINY_SPACING, 0);
        panel.add(UIUtils.createLabel("Drag and drop a folder here", UIConstants.MEDIUM_FONT_SIZE, UIManager.getColor("Label.disabledForeground")), gbc);
        
        gbc.gridy++; gbc.insets = new Insets(0, 0, UIConstants.EXTRA_LARGE_SPACING, 0);
        panel.add(UIUtils.createLabel("or click the button below to browse", UIConstants.MEDIUM_FONT_SIZE, UIManager.getColor("Label.disabledForeground")), gbc);
        
        // Browse button
        gbc.gridy++; gbc.insets = new Insets(0, 0, 0, 0);
        JButton browseButton = UIUtils.createButton("Browse for Folder", FontAwesomeSolid.SEARCH, e -> browseForFolder());
    ...
    private JPanel createFolderInfoPanel() {
        ...
        panel.add(UIUtils.createBoldLabel("Selected Folder:", UIConstants.SMALL_FONT_SIZE), BorderLayout.WEST);
        
        folderPathLabel = UIUtils.createLabel("No folder selected", UIConstants.SMALL_FONT_SIZE, UIManager.getColor("Label.disabledForeground"));
