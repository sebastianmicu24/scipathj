...
public class PipelineSelectionPanel extends JPanel {
    ...
    private class PipelineBox extends JPanel {
        ...
        private void initializeBox() {
            ...
            setCursor(pipeline.isEnabled() ? Cursor.getPredefinedCursor(Cursor.HAND_CURSOR) :
                     Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
            
            // Content panel
            JPanel contentPanel = new JPanel(new BorderLayout());
            contentPanel.setOpaque(false);
            contentPanel.setBorder(UIUtils.createPadding(UIConstants.MEDIUM_SPACING + UIConstants.SMALL_SPACING,
                UIConstants.LARGE_SPACING, UIConstants.MEDIUM_SPACING + UIConstants.SMALL_SPACING, UIConstants.LARGE_SPACING));
            ...
            if (!pipeline.isEnabled()) {
                ...
                statusLabel.setFont(statusLabel.getFont().deriveFont(Font.ITALIC, UIConstants.SMALL_FONT_SIZE + 1f));
            ...
            // Description
            JLabel descLabel = new JLabel("<html><div style='margin-top: 5px;'>" +
                                         pipeline.getDescription() + "</div></html>");
    ...
    private JPanel createButtonPanel() {
        ...
        continueButton = UIUtils.createStandardButton("Continue",
            FontIcon.of(FontAwesomeSolid.ARROW_RIGHT, 16));
