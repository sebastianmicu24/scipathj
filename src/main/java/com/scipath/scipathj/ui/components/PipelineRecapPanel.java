...
import com.scipath.scipathj.ui.dialogs.settings.*;
...
public class PipelineRecapPanel extends JPanel {
    ...
    private void initializeComponents() {
        ...
        pipelineNameLabel = UIUtils.createBoldLabel("No pipeline selected", UIConstants.SUBTITLE_FONT_SIZE);
    ...
    private void updateStepsDisplay() {
        ...
        for (int i = 0; i < steps.length; i++) {
            ...
            if (i < steps.length - 1) {
                JLabel arrow = UIUtils.createIconLabel(FontAwesomeSolid.ARROW_RIGHT, 18, UIManager.getColor("Label.disabledForeground"));
    ...
    private class StepBox extends JPanel {
        ...
        private JPanel createContent() {
            ...
            // Step name
            JLabel nameLabel = UIUtils.createLabel("<html><center>" + stepName + "</center></html>",
                                                  UIConstants.TINY_FONT_SIZE, null);
        ...
        private void openSettingsDialog() {
            ...
            // Based on the actual pipeline: Vessel Segmentation, Nuclear Segmentation, Cell Creation, Feature Extraction, Cell Classification, Final Analysis
            switch (stepNumber) {
                case 1: // Vessel Segmentation
                    dialog = new VesselSegmentationSettingsDialog(parentFrame);
                    break;
                case 2: // Nuclear Segmentation
                    dialog = new NuclearSegmentationSettingsDialog(parentFrame);
                    break;
        ...
        private JPanel createNumberBadge() {
            ...
            JLabel numberLabel = UIUtils.createBoldLabel(String.valueOf(stepNumber), UIConstants.NORMAL_FONT_SIZE);
        ...
        private void drawGearIcon(Graphics2D g2d) {
            ...
            Color gearColor = ThemeManager.isDarkTheme() ?
                new Color(200, 200, 200, 180) : // Light gray for dark theme
