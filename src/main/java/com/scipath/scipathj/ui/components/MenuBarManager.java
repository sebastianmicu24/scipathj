...
import com.scipath.scipathj.ui.dialogs.AboutDialog;
import com.scipath.scipathj.ui.dialogs.PreferencesDialog;
import com.scipath.scipathj.ui.dialogs.settings.VesselSegmentationSettingsDialog;
...
public class MenuBarManager {
     ...
     */
    public MenuBarManager(JFrame parentFrame) {
    ...
    private void handleVesselSettings(java.awt.event.ActionEvent e) {
        ...
        VesselSegmentationSettingsDialog dialog = new VesselSegmentationSettingsDialog(parentFrame);
