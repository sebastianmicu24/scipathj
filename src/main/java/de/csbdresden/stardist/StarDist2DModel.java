...
public class StarDist2DModel {
  ...
  static {
    MODELS.put(
        MODEL_DSB2018_PAPER,
        new StarDist2DModel(
            StarDist2DModel.class.getClassLoader().getResource("models/2D/dsb2018_paper.zip"),
            0.417819,
            0.5,
            8,
            48));
    MODELS.put(
        ...
        new StarDist2DModel(
            StarDist2DModel.class
                .getClassLoader()
                .getResource("models/2D/dsb2018_heavy_augment.zip"),
            0.479071,
            0.3,
            16,
            96));
    MODELS.put(
        ...
        new StarDist2DModel(
            StarDist2DModel.class.getClassLoader().getResource("models/2D/he_heavy_augment.zip"),
            0.692478,
            0.3,
            16,
            96));
  ...
  public StarDist2DModel(
      URL url, double probThresh, double nmsThresh, int sizeDivBy, int tileOverlap) {
    this.url = url;
